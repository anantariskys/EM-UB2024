    ...
    return (
        <div className="scroll-smooth bg-primary-white font-helvetica-regular ">
            <motion.section
                ...
                className="h-screen    container px-4 lg:px-24 py-40 lg:pb-0  top-0 lg:pt-20 font-helvetica-extraBold text-primary-tealBlue flex flex-col "
            >
                ...
                <div className="overflow-hidden h-fit lg:h-24 ">
                    <motion.h1
                        initial={{
                            y: 100,
                        }}
                        ...
                        className="text-3xl lg:text-7xl font-bold  h-fit lg:h-24"
                    >
                        Eksekutif Mahasiswa
                    </motion.h1>
                </div>
                <div className="overflow-hidden h-fit lg:h-24 ">
                    <motion.h1
                        ...
                        className="text-3xl lg:text-7xl font-bold  h-24 "
                    >
            ...
            >
                ...
                <section className="h-screen w-full sticky top-0 bg-gradient-to-b z-0 from-primary-tealBlue to-primary-skyBlue "></section>
              <Kabinet/>
              <Sambutan/>
